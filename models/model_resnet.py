...
def load_model_and_optimizer(
    ...
    if config.exc_resume:
        model_state_path = os.path.join(experiment_path, "model-resnet.pth")
        optim_state_path = os.path.join(experiment_path, "optim-resnet.pth")
...
def test_model(
    ...
    if not config.exc_dry_run:
        plt.savefig(os.path.join(experiment_path, f"test_resnet_epoch_{epoch}.png"))
    plt.close()
