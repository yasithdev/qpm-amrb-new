...
# export MODEL_NAME=rescaps_margin_mse      # margin + mse
# export MODEL_NAME=rescaps_margin          # just margin
export MODEL_NAME=rescaps_edl_mse         # evidential + mse
# export MODEL_NAME=rescaps_edl             # just evidential
