...
umapz-mnist-kfold-%:
	DATASET_NAME=MNIST.$${CV_K} CV_MODE=k-fold    CV_FOLDS=10 MODEL_NAME=$* ${RUN_ARGS} python -u 5_umap.py
...
umapz-mnist-leaveout-%:
	DATASET_NAME=MNIST.$${CV_K} CV_MODE=leave-out CV_FOLDS=10 MODEL_NAME=$* ${RUN_ARGS} python -u 5_umap.py
...
umapz-cifar10-kfold-%:
	DATASET_NAME=CIFAR10.$${CV_K} CV_MODE=k-fold    CV_FOLDS=10 MODEL_NAME=$* ${RUN_ARGS} python -u 5_umap.py
...
umapz-cifar10-leaveout-%:
	DATASET_NAME=CIFAR10.$${CV_K} CV_MODE=leave-out CV_FOLDS=10 MODEL_NAME=$* ${RUN_ARGS} python -u 5_umap.py
...
umapz-amrb2_species-kfold-%:
	DATASET_NAME=AMRB2_species.$${CV_K} CV_MODE=k-fold    CV_FOLDS=10 MODEL_NAME=$* ${RUN_ARGS} python -u 5_umap.py
...
umapz-amrb2_species-leaveout-%:
	DATASET_NAME=AMRB2_species.$${CV_K} CV_MODE=leave-out CV_FOLDS=4  MODEL_NAME=$* ${RUN_ARGS} python -u 5_umap.py
